...
export default function TeacherBudgetConfirmation() {
  const [requests, setRequests] = useState(initialBudgetRequests);
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold">Budget Confirmation</h1>
        ...
        <table className="min-w-full text-left">
          <thead className="bg-gray-50 border-b">
            <tr>
              ...
              <th className="p-3 text-sm font-semibold">Amount (BDT)</th>
